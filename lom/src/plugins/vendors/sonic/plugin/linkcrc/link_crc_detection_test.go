...
func Test_LinkCrcDetectionPlugin_DetectCrcReturnsNilForError(t *testing.T) {
    // Mock
    linkCRCDetectionPlugin := LinkCRCDetectionPlugin{}
    actionConfig := lomcommon.ActionCfg_t{Name: "link_crc_detection", HeartbeatInt: 10}
    linkCRCDetectionPlugin.Init(&actionConfig)
...
func Test_LinkCrcDetectionPlugin_GetPluginIdReturnsPluginDetails(t *testing.T) {
    ...
    assert.Equal("link_crc_detection", pluginId.Name, "PluginId.Name is expected to be link_crc_detection")
...
func Test_LinkCrcDetectionPlugin_InitReturnsErrorForInvalidActionConfig(t *testing.T) {
    // Mock
    linkCRCDetectionPlugin := LinkCRCDetectionPlugin{}
    actionConfig := lomcommon.ActionCfg_t{Name: "link_crc_detection", HeartbeatInt: -1}
...
func (mockLimitDetectionReportingFrequency *MockLimitDetectionReportingFrequency) AddEntry(anomalyKey string) {
    mockLimitDetectionReportingFrequency.Called(anomalyKey)
}

func (mockLimitDetectionReportingFrequency *MockLimitDetectionReportingFrequency) DeleteCache(anomalyKey string) {
    mockLimitDetectionReportingFrequency.Called(anomalyKey)
}

func (mockLimitDetectionReportingFrequency *MockLimitDetectionReportingFrequency) GetNextExpiry() (string, time.Time) {
    args := mockLimitDetectionReportingFrequency.Called()
